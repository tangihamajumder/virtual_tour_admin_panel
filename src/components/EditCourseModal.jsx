...
import {useEditCourseMutation, useGetCourseByIdQuery} from "../redux/features/courses/coursesApi.js";
    ...
    const handleImage = (e) => {
        ...
        axios.post('https://api.imgbb.com/1/upload', imgData)
            .then(function (response) {
                setCourseDetails({...courseDetails, imgURL: response.data.data.display_url});
            })
